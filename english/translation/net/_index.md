...
description: "Translate plain text, Microsoft Word, Excel, PowerPoint, PDF OpenDocument & Markdown documents between 32 most popular business languages using documents translation Cloud SDK & REST API."
button:
    enable: true
